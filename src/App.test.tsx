...
describe("App", () => {
  ...
  it("renders the language switcher with zh-Hant + ja options (#299)", () => {
    // This branch ships zh-Hant + ja, so LANGUAGE_OPTIONS.length > 1 and the
    ...
    expect(options.map((o) => o.textContent)).toEqual(["繁中", "日本語"]);
  });
