...
describe("App", () => {
  ...
  it("renders the language switcher with zh-Hant + th options (#299)", () => {
    // This branch ships zh-Hant + th, so LANGUAGE_OPTIONS.length > 1 and the
    // header switcher renders with one option per shipped locale.
    render(<App />);
    ...
    expect(options.map((o) => o.textContent)).toEqual(["繁中", "ไทย"]);
  });
