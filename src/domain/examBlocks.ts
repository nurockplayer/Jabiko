...
,
  ...
  examQuestion({
    ...
    expectedAnswer: "まいにち",
    options: ["まいにち", "まいじつ", "まいひ", "まいにつ"],
    explanation: "「毎」讀「まい」、「日」在此讀「にち」，故「毎日」＝まいにち。「まいじつ」「まいひ」用了「日」的其他音/訓讀（じつ・ひ）而非此處的「にち」；「まいにつ」把「にち」誤讀成促音「につ」。",
  ...
  examQuestion({
    ...
    promptLabel: "文法形式選擇",
    instructionZh: "句中填空：依文脈選最自然的文法。",
    promptText: "週末は 家で ゆっくり 映画を 見る ___ です。",
    promptContextZh: "週末打算在家悠閒地看電影。",
    hintZh: "說話者對週末的個人計畫。",
    expectedAnswer: "つもり",
    options: ["つもり", "らしい", "そう", "ながら"],
    explanation: "「Vる＋つもりだ」表示說話者主觀的打算，本句是「週末打算在家看電影」。「らしい」是傳聞／推測別人的事，不用於陳述自己的計畫；「そう」（樣態）需接ます形（見そう），接辭書形「見るそう」會變傳聞，且語意是『看起來要看電影』不通；「ながら」是「一邊…一邊…」，「見るながら」接續也不對。唯表個人意圖的「つもり」成立。"
  }),
  examQuestion({
  ...
  examQuestion({
    ...
    expectedAnswer: "伝えて",
    options: ["伝えて", "教えて", "話して", "聞いて"],
    explanation: "「伝える」指把訊息／話語轉告給某人，本句是請對方把「會議三點開始」這句話帶給田中先生，與「と〜てください」的引用轉告句式最搭。「教える」偏「教導知識／告知不知道的資訊」，轉達他人留言時不如「伝える」貼切；「話す」是「說話／聊」，無『代為轉告特定一句話』的意思；「聞く」是「聽／問」，方向相反。唯「伝えて」成立。"
  }),
  examQuestion({
