...
,
  ...
  examQuestion({
    ...
    promptLabel: "文法形式選擇",
    instructionZh: "句中填空：依文脈選最自然的文法。",
    promptText: "ミスを減らすため、退社前には必ず翌日の予定を見直す ___。",
    promptContextZh: "為了減少失誤，我平時都會努力做到下班前一定重看隔天的行程。",
    hintZh: "為減少失誤而在日常中持續維持的一個習慣動作。",
    expectedAnswer: "ようにしている",
    options: ["ようにしている", "ようになっている", "ことになっている", "ところだった"],
    explanation: "「Vる + ようにしている」表示「（靠自身努力）養成並持續維持某習慣」，本句「平時都盡量做到下班前重看行程」正是此義。「ようになっている」是「（自然）變成如此的狀態」（非自身刻意維持）；「ことになっている」是「（依規定／安排）成為…」（外部規定，非自身努力）；「ところだった」是「差點…／正要…」（時間點，語意不合）。表持續努力的習慣唯「ようにしている」吻合。"
  })
];
