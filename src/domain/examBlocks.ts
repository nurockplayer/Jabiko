...
,
  ...
  examQuestion({
    ...
    expectedAnswer: "あげく",
    options: ["あげく", "ばかりか", "ところを", "となれば"],
    explanation: "「Vたあげく」表示經過一番折騰之後，最後得到（多半不理想的）結果，本句是走了一小時又繞回原處。「ばかりか」是『不僅…還…』（同方向追加）；「ところを」表示『正當某狀況時（被打擾／被看見）』；「となれば」是假設條件『一旦變成…的話』，三者都不符合『折騰一番後的結果』語感，唯「あげく」成立。"
  })
];
