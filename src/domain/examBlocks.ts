...
,
  ...
  examQuestion({
    ...
    options: ["だの / だの", "やら / やら", "とか / とか", "なり / なり"],
    explanation: "「AだのBだの」是帶抱怨、不滿語感的列舉，本句「又是忙啦又是累啦地抱怨」與句末「文句ばかり」呼應；兩格皆須填同一詞構成配對。「やら / やら」是中性的混雜列舉（無抱怨色彩）；「とか / とか」是口語中性舉例；「なり / なり」是「擇一去做」的指示。三者都不帶抱怨語感，唯「だの / だの」貼合「文句ばかり」。"
  }),
  examQuestion({
    ...
    options: ["やら / やら", "だの / だの", "とか / とか", "なり / なり"],
    explanation: "「AやらBやら」表達「又是…又是…」的混雜列舉，帶「事情多到暈頭轉向」的語感，本句「又要打包又要跑公家機關，忙得頭暈」正是此義；兩格皆須填同一詞構成配對。「だの / だの」帶較強抱怨色彩（本句是中性忙亂，非抱怨）；「とか / とか」少了「混亂」感；「なり / なり」是「擇一去做」的指示。表忙亂混雜唯「やら / やら」最自然。"
  }),
  examQuestion({
