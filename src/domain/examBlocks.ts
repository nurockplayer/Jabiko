...
,
  ...
  examQuestion({
    ...
    options: ["だの / だの", "につけ / につけ", "とか / とか", "なり / なり"],
    explanation: "「AだのBだの」是帶抱怨、不滿語感的列舉，本句「又是忙啦又是累啦地抱怨」與句末「文句ばかり」呼應；兩格皆須填同一詞構成配對。「につけ / につけ」是「每當…就…」的伴隨表現（接「忙しい／疲れた」い形容詞不合，也非抱怨列舉）；「とか / とか」是口語中性舉例；「なり / なり」是「擇一去做」的指示。三者都不貼合「文句ばかり」的抱怨語感，唯「だの / だの」成立。"
  }),
  examQuestion({
