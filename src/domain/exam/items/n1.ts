...
export const n1Items: PracticeQuestion[] = [
  ...
  examQuestion({
    ...
    hintZh: "最高水準には届かなくても、最低限の目標を示す文脈。",
  ...
  examQuestion({
    ...
    hintZh: "軽い前項なら許せても、後項は度を超している文脈。",
    expectedAnswer: "ならまだしも",
