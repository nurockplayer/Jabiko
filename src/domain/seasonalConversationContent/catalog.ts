...
const familyInputs: readonly FamilyInput[] = [
  {
    ...
    phases: [
      ...
      phase({
        ...
        objective: text("敘述一段安靜休息的經驗，回應對方的休息偏好，再連結到平日短暫休息方式。", "静かに休んだ経験を話し、相手の休み方の好みに応じて、普段の短い休み方へ話をつなげましょう。", "Narrate a quiet break, respond to the partner's rest preference, and bridge to a brief everyday rest routine."),
        instruction: text("說明自己的休息安排，回應對方的偏好，再分享適合自己的短暫休息方式。", "自分がどう休んだかを話し、相手の好みに応じて、自分に合う短い休み方を話しましょう。", "Describe how you rested, respond to the partner's preference, and share a brief routine that suits you."),
        ...
        turns: [
          ...
          turn("私は少し歩くと気分転換になりますが、混んでいる場所は避けたいです。", text("回應對方喜歡散步但避開人潮的偏好，並分享自己的相近或不同想法。", "散歩は気分転換になる一方、人の多い場所は避けたいという相手の話に応じましょう。", "Respond to the partner enjoying walks but preferring to avoid crowds, and share a similar or different preference."),
        ...
        completion: text("你敘述了自己的年始經驗、回應對方的休息偏好，也連結到適合平日的短暫休息方式。", "年始の経験を話し、相手の休み方の好みに応じながら、普段の忙しい週に合う休み方へ話をつなげられました。", "You narrated your New Year experience, responded to the partner's rest preference, and bridged to a brief routine for a busy week.")
      })
    ]
  },
  {
