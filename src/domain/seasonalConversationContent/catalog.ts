...
const familyInputs: readonly FamilyInput[] = [
  ...
  },
  {
    ...
    phases:[
      ...
      draftPhase({phase:"active",length:"short",learnerRole:"participant",partnerRole:"participant",relationship:text("在公園入口偶然聊天的參觀者。","公園の入口で話す来園者同士。","Visitors chatting at a park entrance."),situation:text("參觀者看到空中飄動的鯉魚旗。","来園者が空に泳ぐこいのぼりを見ています。","Visitors watch koinobori moving overhead."),objective:text("描述一個眼前的細節；對方也可以補充觀察。","目の前の特徴を一つ話しましょう。相手の感想は必要なら聞けます。","Describe one visible detail; the partner may add another observation."),instruction:text("以眼前看到的景象為限，不宣稱每個家庭都會展示。","今見えている風景を話し、どの家庭も飾るとは言わないようにしましょう。","Stay with the visible scene; do not claim every household displays them."),primarySkills:["react","share","expand"],difficulty:BASIC_SUPPORTIVE,partner:"風が吹くと、旗が大きく動きますね。",prompt:text("回應旗子的動態，也可以補充自己注意到的其他細節。","旗の動きに応じ、気づいた特徴を話しましょう。","Respond to the movement; optionally add another detail you noticed."),choices:[{japanese:"空を泳いでいるようですね。色の並びもきれいです。",discourse:"The learner responds to the visible movement and adds a visual detail.",profile:ANSWER_ONLY},{japanese:"風があるとよく動きますね。近くで見ると模様も違いますか？",discourse:"The learner follows the visible scene with a specific optional question.",profile:ACKNOWLEDGE_AND_INVITE}],completion:text("你描述了眼前可見的景象，也交換了觀察。","目の前の風景を話し、観察を交換できました。","You described the visible scene and exchanged observations.")}),
      draftPhase({phase:"after",length:"medium",learnerRole:"classmate",partnerRole:"classmate",relationship:text("平常會交換生活見聞的同學。","日々の見聞を話すクラスメート。","Classmates who share everyday observations."),situation:text("同學比較在公園與河邊看過的公共季節展示，以及各自注意到的小細節。","クラスメートが公園や川沿いで見た季節展示と、そこで気づいたことを比べています。","Classmates compare public seasonal displays they saw in a park and by a river."),objective:text("比較一項觀察，詢問對方印象最深的部分。","見たものを比べ、相手に一番印象に残った点を尋ねましょう。","Compare one observation and ask what stayed with the partner."),instruction:text("分享個人印象，避免把文化景象說成每個人都參與的儀式。","個人の印象として話し、誰もが参加する儀式とは言わないようにしましょう。","Keep it personal rather than describing a universal ritual."),primarySkills:["share","expand"],difficulty:INTERMEDIATE_SOCIAL,partner:"川沿いで見たこいのぼりは、場所によって大きさが違っていました。",prompt:text("回憶自己的觀察，再問對方看到什麼差異。","自分の観察を振り返り、どんな違いを見たか尋ねましょう。","Recall your observation and ask what difference the partner saw."),choices:[{japanese:"私は色の組み合わせをよく覚えています。川沿いは風が強かったですか？",discourse:"The learner recalls a personal detail and asks about the setting.",profile:ANSWER_ONLY},{japanese:"大きさが違うと印象も変わりますね。どの旗が一番目に留まりましたか？",discourse:"The learner responds and asks which visible item caught the partner's eye.",profile:ACKNOWLEDGE_AND_INVITE}],followUps:[{partner:"場所によって大きさが違うと、見え方も変わりますね。",prompt:text("比較兩個公共景象中自己注意到的一項細節。","場所による見え方の違いに触れ、自分が気づいた点を一つ話しましょう。","Compare one detail you noticed across the two public displays."),choices:[{japanese:"大きな旗は遠くからも目に入りました。近くでは色の並びがよく見えました。",discourse:"The learner compares two concrete viewing distances and the details visible at each.",profile:ANSWER_ONLY},{japanese:"川沿いの旗は風で動いていました。公園ではどんなところが印象に残りましたか？",discourse:"The learner connects the earlier display to a new observation and returns the topic.",profile:ANSWER_AND_RETURN}]}],completion:text("你分享並比較了公共展示中的具體觀察。","公共の展示で気づいたことを話し、具体的な違いも比べられました。","You shared and compared concrete observations from public displays.")})
    ]
  },
  {
  ...
  },
  {
    ...
    phases:[
      draftPhase({phase:"before",length:"medium",learnerRole:"coworker",partnerRole:"coworker",relationship:text("能以低壓力方式討論可選安排的同事。","負担の少ない選択肢を話し合える同僚。","Coworkers comfortable discussing optional plans without pressure."),situation:text("年末，兩位同事聊到是否想在公共場所短暫見面；兩人都可婉拒或改期。","年末、同僚同士で公共の場所で短く会う案を話しています。どちらも断ったり別の日にしたりできます。","At year end, coworkers consider a brief public meet-up; either can decline or suggest another day."),objective:text("商量一個時間短、容易婉拒的安靜見面方案，顧及彼此的限制。","短時間で断りやすい静かな待ち合わせを考え、お互いの都合に配慮しましょう。","Negotiate a brief, easy-to-decline quiet meet-up that respects both people's constraints."),instruction:text("只提議中性的公共場所與短時間安排；不預設到對方家裡、參加儀式或熬夜。","中立的な公共の場所と短い時間だけを提案しましょう。相手の家や儀式、夜更かしは前提にしません。","Suggest only a neutral public place and brief duration; do not assume a private home, ritual, or late night."),primarySkills:["negotiate"],difficulty:INTERMEDIATE_SOCIAL,partner:"年末は静かに過ごしたいですが、長く出かけるのは難しそうです。",prompt:text("提出一個短暫的公共場所見面方案，讓對方能婉拒或改期。","短時間の公共の場所で会う案を出し、断ったり別の日にしたりできると伝えましょう。","Offer a brief public meet-up that the partner can decline or reschedule."),choices:[{japanese:"よければ、駅前の静かなカフェで30分ほど話しませんか。都合が合わなければ、また別の日でも大丈夫です。",discourse:"The learner proposes a bounded public option with an explicit, low-pressure alternative.",profile:NEGOTIATE_WITH_REASON},{japanese:"人が少ない時間に、カフェで30分くらい会うのはどうですか。難しければ無理に決めなくて大丈夫です。",discourse:"The learner checks a short public option while making refusal easy.",profile:NEGOTIATE_WITH_REASON}],followUps:[{partner:"人が多い場所は避けたいので、年末は家で好きな番組を見て過ごすつもりです。",prompt:text("相手が家で過ごしたい意向を受け止め、別日や短時間の案も選択肢として残しましょう。","家で過ごしたいという相手の希望を受け止め、別の日や短時間の案も選択肢として残しましょう。","Respect the partner's choice to stay home and leave another day or a shorter option open."),choices:[{japanese:"家で過ごす予定なんですね。では、年明けに人が少ない時間のカフェで30分だけ会う案もあります。もちろん、それぞれ休むだけでも大丈夫です。",discourse:"The learner accepts the partner's current plan and offers a later public option with an easy decline.",profile:NEGOTIATE_WITH_REASON},{japanese:"その過ごし方もよさそうですね。もし別の日に会いたくなったら、空いている時間に短く話すのはどうですか？",discourse:"The learner accepts the choice and makes any later meet-up conditional on mutual interest.",profile:NEGOTIATE_WITH_REASON}]}],completion:text("你提出了短暫、可婉拒的公共場所見面方案，也回應了對方想在家的限制。","短時間で断りやすい公共の待ち合わせを提案し、家で過ごしたい相手の都合にも応じました。","You negotiated a brief, optional public meet-up and respected the partner's preference to stay home.")}),
      ...
      draftPhase({phase:"after",length:"short",learnerRole:"classmate",partnerRole:"classmate",relationship:text("平常會回顧生活小事、彼此不追問家庭計畫的同學。","日々の出来事を振り返るが、家庭の予定は尋ねないクラスメート。","Classmates who recall everyday moments without probing family plans."),situation:text("新的一年開始後，同學回憶一個年末留下印象的時刻。","新しい年になり、クラスメートが年末に印象に残った瞬間を振り返っています。","After the new year begins, classmates recall one memorable year-end moment."),objective:text("描述一個自己記得的片刻，對方也可以選擇分享回憶。","自分が覚えている一場面を話し、相手も話したいことがあれば共有できます。","Describe one moment you chose to remember; the partner may share a memory too."),instruction:text("回憶個人經驗，不假設參拜、聚會或特定倒數活動。","個人の経験を振り返り、参拝や集まり、特定のカウントダウンは前提にしないようにしましょう。","Recall a personal moment without assuming a shrine visit, gathering, or countdown."),primarySkills:["narrate","bounce"],difficulty:INTERMEDIATE_SOCIAL,partner:"年末は家でゆっくりして、好きな音楽を聞いていました。",prompt:text("分享一個自己記得的年末片刻，對方也可補充回憶。","覚えている年末の場面を話し、相手も話したい思い出があれば聞きましょう。","Share a year-end moment; the partner may add a memory if they wish."),choices:[{japanese:"私は温かい飲み物を用意して、前年に撮った写真を見返しました。どんな音楽を聞いていましたか？",discourse:"The learner narrates a chosen year-end moment and returns the topic.",profile:NARRATE_AND_RETURN},{japanese:"私は静かに本を読んでいました。好きな音楽を聞くと、ゆっくりできますね。",discourse:"The learner shares a personal memory and responds to the partner's routine.",profile:ANSWER_ONLY}],completion:text("你敘述了一個自選的年末片刻，也邀請對方分享自己的回憶。","自分で選んだ年末の場面を話し、相手の思い出も聞けました。","You described a chosen year-end moment; the partner could share a memory too.")})
    ]
  },
];
