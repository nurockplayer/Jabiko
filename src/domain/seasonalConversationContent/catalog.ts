...
const ANSWER_ONLY: ResponseProfile = {
  ...
  authorRationale: {
    natural: "The direct response fits the immediate question and the familiar relationship.",
...
const NARRATE_AND_RETURN: ResponseProfile = {
  ...
  authorRationale: {
    natural: "The learner gives a short account and a reciprocal question suited to classmates.",
    continuation: "A concrete experience leads to an optional question that returns the topic.",
    register_context_fit: "The learner asks about study routines without presenting personal advice as universal."
  }
};
...
const familyInputs: readonly FamilyInput[] = [
  {
    ...
    phases: [
      ...
      phase({
        ...
        turns: [
          turn("今日は人通りが少なくて、いつもより静かですね。家でゆっくりすることにしました。", text("回應對方選擇在家休息的分享，談談當下的公共空間。", "家で休むことにした相手の話に応じ、今の公共の場所の様子を話しましょう。", "Respond to the partner choosing to rest at home and comment on the present public space."),
            answer("本当に静かですね。私も今日は予定を入れず、ゆっくり過ごしています。こういう日は何をして休むのが好きですか？", text("認同現在較安靜的觀察，分享自己的休息方式，再詢問對方的偏好。", "今の静けさに触れ、自分の休み方を話してから相手の好みも尋ねます。", "You acknowledge the quiet, share your plan, and ask about the partner's preference."), "The learner responds to the shared observation and returns the topic with one optional question.", ANSWER_AND_RETURN),
      ...
      phase({
        ...
        situation: text("元日過後，兩位同事回顧各自選擇的休息方式；一人在家休息，另一人散步片刻。", "元日を過ごした後、同僚同士でそれぞれの休み方を振り返っています。一人は家で過ごし、もう一人は短い散歩をしました。", "After New Year’s Day, coworkers reflect on their different ways to rest; one stayed home while the other took a short walk."),
        ...
        turns: [
          turn("年始は家で静かに過ごしました。外に出た時間も少しありましたか？", text("敘述自己在家休息的經驗，再回答對方關於外出的問題。", "家で静かに過ごした経験を聞き、外出した時間があったか答えましょう。", "Narrate how you spent quiet time at home and answer whether you went out at all."),
            answer("家で過ごす時間が多かったです。読みかけの本を一冊読み終えて、気持ちに余裕ができました。", text("用具體經驗敘述在家的休息方式與感受。", "家で本を読み終えた経験と、その時に感じた余裕を具体的に話します。", "You narrate a concrete home activity and how it gave you a little breathing room."), "The learner narrates a personal experience and its effect without claiming the same choice suits everyone.", NARRATE_AND_REFLECT),
          ...
          turn("私は少し歩くと気分転換になりますが、混んでいる場所は避けたいです。", text("回應對方偏好散步但避開人潮，分享不同經驗並表示理解。", "散歩は気分転換になる一方、人の多い場所は避けたいという相手の話に応じましょう。", "Respond to the partner enjoying walks but preferring to avoid crowds, and acknowledge the difference."),
            answer("その感じは分かります。私も人が多い場所より、静かな道を歩くほうが落ち着きます。", text("認同避開人潮的感受，並補充自己偏好安靜道路的理由。", "人混みを避けたい気持ちに共感し、自分も静かな道が落ち着くと話します。", "You acknowledge the preference and explain why a quieter route works for you too."), "The learner acknowledges the partner and adds a related personal preference.", ANSWER_ONLY),
          ...
          turn("休み方はいろいろですね。忙しい週の途中なら、どんな短い休み方が合いますか？", text("從年始經驗連結到一般忙碌週中的休息方式。", "年始の経験から、忙しい週の途中に合う短い休み方へ話をつなげましょう。", "Bridge from the holiday account to a brief way of resting during a busy week."),
            answer("私は昼休みに外の空気を吸うと気分が変わります。短くても席を離れるのが合っています。", text("近期的午休經驗說明短暫離席如何幫助自己休息。", "昼休みに外の空気を吸う例を挙げ、短くても席を離れるのが合うと話します。", "You describe how stepping outside briefly during lunch helps you reset."), "The learner bridges the holiday reflection to a concrete personal routine.", NARRATE_AND_REFLECT),
            answer("温かい飲み物を用意して、数分だけ静かにすることがあります。短い時間でも落ち着けます。", text("用具體例子說明短暫安靜如何帶來休息。", "温かい飲み物を用意して数分静かにする例を挙げ、その効果を話します。", "You describe a short quiet pause with a warm drink and how it helps."), "The learner connects the reflection to a specific personal routine.", NARRATE_AND_REFLECT))
        ],
  ...
  },
  {
    ...
    phases:[
      draftPhase({phase:"before",length:"short",learnerRole:"coworker",partnerRole:"coworker",relationship:text("工作場合中友善但有禮的同事。","職場で親しみはあるが礼儀を保つ同僚。","Friendly coworkers who keep workplace politeness."),situation:text("同事在公共大廳看到季節展示的公告。","同僚が公共スペースで季節の展示案内を見ています。","Coworkers notice a seasonal display announcement in a public lobby."),objective:text("詢問對方是否想看展示，不假設其個人慶祝方式。","展示を見たいか尋ね、個人の祝い方は前提にしないようにしましょう。","Ask whether the partner wants to see it without assuming personal celebration."),instruction:text("把展示當成可選的公共觀察，不涉及家庭或性別。","公共の展示として話し、家庭や性別の話を前提にしないようにしましょう。","Treat this as an optional public display, without assumptions about family or gender."),primarySkills:["share"],difficulty:BASIC_SUPPORTIVE,partner:"ロビーにひな人形の展示があるそうです。見に行ってみますか？",prompt:text("回答是否有興趣，並把選擇留給對方。","興味があるか答え、相手にも選ぶ余地を残しましょう。","Say whether you are interested and leave the choice open."),choices:[{japanese:"少し見てみたいです。展示の案内を読んでから行きましょう。",discourse:"The learner accepts the optional public invitation and suggests checking its notice.",profile:ANSWER_ONLY},{japanese:"今日は時間がないので、また機会があれば見たいです。",discourse:"The learner declines politely without implying a customary obligation.",profile:ANSWER_ONLY}],completion:text("你以可選擇的公共展示為話題，沒有假設私人慶祝習慣。","任意で見られる展示の話をし、個人の習慣は決めつけませんでした。","You discussed an optional public display without assuming a private custom.")}),
      draftPhase({phase:"active",length:"short",learnerRole:"participant",partnerRole:"participant",relationship:text("在公共文化空間偶然交談的參觀者。","公共の文化施設で話す来館者同士。","Visitors chatting in a public cultural space."),situation:text("兩位參觀者看著入口附近的雛人形展示。","来館者が入口近くのひな人形の展示を見ています。","Visitors look at a display of hina dolls near an entrance."),objective:text("描述一個可見的展示細節，也可以邀請對方補充。","見える展示の特徴を一つ話し、必要なら相手にも尋ねましょう。","Mention one visible feature and optionally invite the partner's observation."),instruction:text("談展示的顏色或配置，不把它說成所有人都會做的習俗。","色や配置について話し、誰もが行う習慣とは言わないようにしましょう。","Discuss colors or arrangement without calling it universal."),primarySkills:["share","expand"],difficulty:BASIC_SUPPORTIVE,partner:"人形の着物は色の組み合わせがきれいですね。",prompt:text("回應一個可見細節，並邀請對方談展示的另一個部分。","見える特徴に応じ、展示の別の部分について相手の感想を尋ねましょう。","Respond to a visible feature and invite another observation."),choices:[{japanese:"落ち着いた色ですね。並べ方にも工夫があるように見えます。",discourse:"The learner notices the visible colors and arrangement without claiming expertise.",profile:ANSWER_ONLY},{japanese:"本当にきれいですね。小さな道具も丁寧に作られていますね。",discourse:"The learner adds another observable detail to the shared topic.",profile:ANSWER_ONLY}],followUps:[{partner:"段ごとに少しずつ違う道具が置かれていますね。",prompt:text("接續對方指出的配置，詢問其最感興趣的可見部分。","段ごとの道具の違いに触れ、相手が気になった部分を尋ねましょう。","Build on the arrangement and ask which visible part interested the partner."),choices:[{japanese:"私は小さな道具が気になりました。どの部分をよく見ましたか？",discourse:"The learner shares an observation and asks about the partner's chosen detail.",profile:PERSONAL_DETAIL_AND_EXPAND},{japanese:"段ごとに違いがあるんですね。説明の札も読んでみたいです。",discourse:"The learner responds to the display and proposes reading its public caption.",profile:ANSWER_ONLY}]}],completion:text("你觀察了展示的具體細節，也詢問了對方的看法。","展示の具体的な特徴を見て、相手の感想も尋ねられました。","You noticed concrete display details and invited the partner's view.")}),
      draftPhase({phase:"after",length:"short",learnerRole:"classmate",partnerRole:"classmate",relationship:text("平常會分享公共空間見聞的同學。","公共の場所で見たものを話すクラスメート。","Classmates who share observations from public places."),situation:text("參觀者回想最近看過的一個季節展示。","最近見た季節の展示をクラスメート同士で振り返っています。","Classmates recall a seasonal display they recently saw."),objective:text("分享一個自己記得的展示細節。","覚えている展示の特徴を一つ話しましょう。","Share one detail you remember from the display."),instruction:text("只說自己的觀察，不推論對方家庭的習慣。","自分の見たことを話し、相手の家庭の習慣は推測しないようにしましょう。","Share your observation without guessing about the partner's family."),primarySkills:["share"],difficulty:INTERMEDIATE_SOCIAL,partner:"展示の中で、どんなところが印象に残りましたか？",prompt:text("回想一個自己記得的展示細節。","覚えている展示の特徴を一つ思い出しましょう。","Recall one detail you remember from the display."),choices:[{japanese:"入口の近くにあった人形の表情が印象に残りました。",discourse:"The learner recalls one detail from a personally viewed display.",profile:NARRATE_AND_REFLECT},{japanese:"色の違いが分かりやすかったです。あなたはどこをよく覚えていますか？",discourse:"The learner answers and returns the shared observation topic.",profile:ANSWER_AND_RETURN}],completion:text("你分享了一個自己記得的展示觀察。","覚えている展示の特徴を一つ話せました。","You shared one observation that you remembered.")})
    ]
  },
  {
    ...
    phases:[
      ...
      draftPhase({phase:"after",length:"medium",learnerRole:"classmate",partnerRole:"classmate",relationship:text("能坦率交換學習經驗、彼此尊重差異的同學。","勉強の経験を率直に話し、違いも尊重するクラスメート。","Classmates who share study experiences and respect differences."),situation:text("學年開始後，同學回顧一項有用的新習慣，也談到不順利的部分。","新学年が始まった後、役に立った習慣と難しかった点を振り返っています。","After the school-year start, classmates reflect on a helpful new habit and one difficulty."),objective:text("分享一段混合經驗，追問對方有效的方法並把話題交回去。","うまくいった点と難しかった点を話し、相手の工夫も尋ねましょう。","Share a mixed experience, ask about the partner's method, and return the turn."),instruction:text("講述自己試過的做法與結果，避免把個人經驗當成通用建議。","試した方法と結果を話し、個人の経験を誰にでも当てはまる助言にしないようにしましょう。","Describe your own attempt without presenting it as universal advice."),primarySkills:["narrate","share","bounce"],difficulty:INTERMEDIATE_SOCIAL,partner:"毎日少し復習するのは続いていますが、予定が重なる日は難しいです。",prompt:text("說明自己如何調整學習時間，再詢問對方哪個時段較能持續。","自分がどう時間を調整したか話し、続けやすい時間帯を尋ねましょう。","Explain your adjustment and ask which time works for the partner."),choices:[{japanese:"私は帰宅後すぐではなく、夕食の後に短く復習するようにしました。どの時間が続けやすいですか？",discourse:"The learner narrates a specific adjustment and asks about the partner's routine.",profile:NARRATE_AND_RETURN},{japanese:"忙しい日は一問だけにして、余裕がある日に多めにしています。あなたはどう調整していますか？",discourse:"The learner describes a flexible strategy and returns the question.",profile:NARRATE_AND_RETURN}],followUps:[{partner:"時間を決めすぎず、できる日に短くやるのが合いそうです。",prompt:text("回應對方的彈性做法，再分享自己的看法。","相手の柔軟な方法に応じ、自分の考えも一つ話しましょう。","Respond to the flexible approach and share your view."),choices:[{japanese:"決めすぎないほうが続けやすいですね。私も忙しい日は短くすることにしています。",discourse:"The learner acknowledges and adds a related experience.",profile:ANSWER_ONLY},{japanese:"その方法は無理がなさそうです。私は週に一度、できたことを見直したいです。",discourse:"The learner recognizes the approach and shares a different personal preference.",profile:ANSWER_ONLY}]}],completion:text("你回顧了實際嘗試與調整，也尊重每個人的學習節奏不同。","試したことと調整を振り返り、人によって続けやすい方法が違うことも話せました。","You reflected on an actual adjustment and recognized that routines differ.")})
    ]
  },
  {
    ...
    phases:[
      draftPhase({phase:"before",length:"short",learnerRole:"coworker",partnerRole:"coworker",relationship:text("會在午休聊附近街景的同事。","昼休みに近所の様子を話す同僚。","Coworkers who chat about nearby sights at lunch."),situation:text("同事在街上看到懸掛鯉魚旗的活動公告。","同僚が街でこいのぼりの展示案内を見かけました。","Coworkers notice a public koinobori display announcement."),objective:text("詢問對方是否想去看看，並說明自己的選擇。","見に行きたいか尋ね、自分の考えも話しましょう。","Ask whether the partner wants to see it and share your own choice."),instruction:text("只談可選的公共活動，不預設對方有孩子。","任意の公共イベントとして話し、相手に子どもがいるとは決めつけないようにしましょう。","Keep it an optional public event; do not assume the partner has children."),primarySkills:["share"],difficulty:BASIC_SUPPORTIVE,partner:"駅前にこいのぼりが飾られるそうです。見に行く予定はありますか？",prompt:text("回答是否有興趣，再詢問對方想看的部分。","興味があるか答え、相手が見たいところも尋ねましょう。","Say whether you are interested and ask what the partner wants to see."),choices:[{japanese:"少し見てみたいです。風で動くところが気になります。",discourse:"The learner answers and names a visible feature of interest.",profile:ANSWER_ONLY},{japanese:"まだ決めていません。通りかかった時に見られたら十分です。",discourse:"The learner gives a noncommittal personal preference.",profile:ANSWER_ONLY}],completion:text("你談了可自由選擇的公共展示，沒有假設對方的家庭狀況。","任意で見られる展示について話し、相手の家庭事情は推測しませんでした。","You discussed an optional public display without assuming the partner's family situation.")}),
      draftPhase({phase:"active",length:"short",learnerRole:"participant",partnerRole:"participant",relationship:text("在公園入口偶然聊天的參觀者。","公園の入口で話す来園者同士。","Visitors chatting at a park entrance."),situation:text("參觀者看到空中飄動的鯉魚旗。","来園者が空に泳ぐこいのぼりを見ています。","Visitors watch koinobori moving overhead."),objective:text("描述一個眼前的細節，邀請對方分享觀察。","目の前の特徴を一つ話し、相手の感想を尋ねましょう。","Describe one visible detail and invite an observation."),instruction:text("以眼前看到的景象為限，不宣稱每個家庭都會展示。","今見えている風景を話し、どの家庭も飾るとは言わないようにしましょう。","Stay with the visible scene; do not claim every household displays them."),primarySkills:["react","share","expand"],difficulty:BASIC_SUPPORTIVE,partner:"風が吹くと、旗が大きく動きますね。",prompt:text("回應旗子的動態，再問對方注意到的其他細節。","旗の動きに応じ、ほかに気づいた特徴も尋ねましょう。","Respond to the movement and ask what else the partner noticed."),choices:[{japanese:"空を泳いでいるようですね。色の並びもきれいです。",discourse:"The learner responds to the visible movement and adds a visual detail.",profile:ANSWER_ONLY},{japanese:"風があるとよく動きますね。近くで見ると模様も違いますか？",discourse:"The learner follows the visible scene with a specific optional question.",profile:ACKNOWLEDGE_AND_INVITE}],completion:text("你描述了眼前可見的景象，並邀請對方分享觀察。","目の前の風景を話し、相手の観察も聞けました。","You described the visible scene and invited the partner's observation.")}),
      draftPhase({phase:"after",length:"medium",learnerRole:"classmate",partnerRole:"classmate",relationship:text("平常會交換生活見聞的同學。","日々の見聞を話すクラスメート。","Classmates who share everyday observations."),situation:text("同學回想看過的一個公共季節展示，以及自己注意到的小細節。","クラスメートが公共の季節展示と、そこで気づいたことを振り返っています。","Classmates recall a public seasonal display and a detail they noticed."),objective:text("比較一項觀察，詢問對方印象最深的部分。","見たものを比べ、相手に一番印象に残った点を尋ねましょう。","Compare one observation and ask what stayed with the partner."),instruction:text("分享個人印象，避免把文化景象說成每個人都參與的儀式。","個人の印象として話し、誰もが参加する儀式とは言わないようにしましょう。","Keep it personal rather than describing a universal ritual."),primarySkills:["share","narrate","expand"],difficulty:INTERMEDIATE_SOCIAL,partner:"川沿いで見たこいのぼりは、場所によって大きさが違っていました。",prompt:text("回憶自己的觀察，再問對方看到什麼差異。","自分の観察を振り返り、どんな違いを見たか尋ねましょう。","Recall your observation and ask what difference the partner saw."),choices:[{japanese:"私は色の組み合わせをよく覚えています。川沿いは風が強かったですか？",discourse:"The learner recalls a personal detail and asks about the setting.",profile:NARRATE_AND_REFLECT},{japanese:"大きさが違うと印象も変わりますね。どの旗が一番目に留まりましたか？",discourse:"The learner responds and asks which visible item caught the partner's eye.",profile:ACKNOWLEDGE_AND_INVITE}],completion:text("你交換了個人觀察，也延續了對公共景象的對話。","自分の印象を話し、公共の風景について会話を続けられました。","You shared personal observations and continued the conversation about a public scene.")})
    ]
  },
  {
  ...
  },
  {
    ...
    phases:[
      draftPhase({phase:"before",length:"short",learnerRole:"classmate",partnerRole:"classmate",relationship:text("平常會聊個人目標但不要求揭露私事的同學。","個人的な目標を話すことはあるが、私事を求めないクラスメート。","Classmates who sometimes discuss goals without demanding personal details."),situation:text("同學看到文化中心將設置短冊展示的公告。","文化施設に短冊の展示が設置される案内を見ています。","Classmates see a notice for a wish-strip display at a cultural center."),objective:text("討論是否想寫下一個輕鬆的小願望。","気軽な願いを書いてみたいか話しましょう。","Discuss whether to write a low-pressure wish."),instruction:text("願望可以很普通或不分享，不追問個人隱私。","願いは日常的なものでも、共有しなくてもよいと伝えましょう。","Keep wishes ordinary or private; do not press for personal details."),primarySkills:["share"],difficulty:BASIC_SUPPORTIVE,partner:"短冊に願いを書くコーナーができるそうです。何か書いてみたいですか？",prompt:text("回答是否有興趣，提出一個自選的小目標。","興味があるか答え、自分で選べる小さな目標を話しましょう。","Say whether you are interested and offer an optional small goal."),choices:[{japanese:"日本語の本を一冊読みたいです。小さな目標なら書きやすそうですね。",discourse:"The learner shares a modest, self-chosen learning goal.",profile:ANSWER_ONLY},{japanese:"まだ考えていません。見本を読んでから決めてもよさそうです。",discourse:"The learner leaves the choice open and does not treat participation as required.",profile:ANSWER_ONLY}],completion:text("你談了是否想寫下小目標，保留不分享的空間。","自分で選べる目標を話し、共有しない選択肢も保てました。","You discussed an optional goal and left room not to share one.")}),
      draftPhase({phase:"active",length:"short",learnerRole:"participant",partnerRole:"participant",relationship:text("在公共展示前交談的參觀者。","公共展示の前で話す来場者同士。","Visitors talking beside a public display."),situation:text("參觀者看到一張寫著學習願望的短冊。","来場者が学習について書かれた短冊を見ています。","Visitors see a wish strip about learning."),objective:text("對展示作簡短回應，不探問作者身分。","展示に短く反応し、書いた人の身元は尋ねないようにしましょう。","Respond to the display without asking who wrote it."),instruction:text("只談公開展示上的文字，不猜測私人背景。","公開展示の言葉だけを話題にし、個人的な事情を推測しないようにしましょう。","Discuss only the displayed words; do not guess at private circumstances."),primarySkills:["react","expand"],difficulty:INTERMEDIATE_SOCIAL,partner:"『毎日少しずつ続けたい』と書いてありますね。",prompt:text("回應這個可見願望，分享一個讓小目標容易持續的想法。","見える願いに応じ、小さな目標を続ける工夫を一つ話しましょう。","Respond to the visible wish and share one way to sustain a small goal."),choices:[{japanese:"少しずつという言葉がいいですね。時間を短くすると続けやすそうです。",discourse:"The learner reacts to the displayed wording and adds a practical thought.",profile:ANSWER_ONLY},{japanese:"無理のない目標ですね。続けるために何を決めるとよさそうですか？",discourse:"The learner comments on the modest goal and invites a general reflection.",profile:ACKNOWLEDGE_AND_INVITE}],completion:text("你回應了展示文字，也沒有推測書寫者的私事。","展示の言葉に応じ、書いた人の事情は推測しませんでした。","You responded to the display without guessing at the author's private life."),
        followUps:[{partner:"私は勉強する時間を決めず、できる日に少し読むつもりです。",prompt:text("理解對方選擇彈性方法的理由，分享相近或不同的策略。","柔軟な方法を選んだ相手に応じ、自分の工夫も話しましょう。","Respond to the partner's flexible approach with your own method."),choices:[{japanese:"決めすぎないほうが気楽ですね。私は本を机の上に置いておきます。",discourse:"The learner acknowledges the partner's choice and adds a personal cue.",profile:ANSWER_ONLY},{japanese:"できる日に読むのは続けやすそうです。私は短い章から始めたいです。",discourse:"The learner adds a practical personal approach to the shared goal.",profile:ANSWER_ONLY}]}]}),
      draftPhase({phase:"after",length:"long",learnerRole:"classmate",partnerRole:"classmate",relationship:text("熟悉但尊重彼此自主性的同學。","親しみがありつつ、お互いの自主性を尊重するクラスメート。","Familiar classmates who respect one another's autonomy."),situation:text("活動後，同學回顧一個持續中的個人目標，以及讓計畫不易維持的原因。","行事の後、続けている目標と、計画が難しくなる理由を振り返っています。","After an event, classmates reflect on an ongoing goal and what makes it difficult to sustain."),objective:text("敘述一段目標經驗，理解不同方法，再商量一個可調整的小步驟。","目標の経験を話し、違う方法も受け止め、調整できる小さな一歩を考えましょう。","Narrate a goal experience, recognize different methods, and negotiate an adaptable next step."),instruction:text("說明目標對自己的意義，聽取對方限制，再提出不強迫的調整方案。","目標の意味を話し、相手の事情も聞いて、無理のない調整案を考えましょう。","Explain what matters to you, hear the partner's constraint, and propose a flexible adjustment."),primarySkills:["narrate","negotiate"],difficulty:ADVANCED_REFLECTIVE,partner:"目標は続けたいのですが、忙しい日は予定どおりにできません。",prompt:text("敘述自己曾如何調整類似目標，也詢問對方的偏好。","似た目標をどう調整したか話し、相手の希望も尋ねましょう。","Narrate how you adjusted a similar goal and ask what the partner prefers."),choices:[{japanese:"以前は毎日読む目標にしましたが、忙しい日にできないと、続けること自体をあきらめそうになりました。そこで時間のある日に数ページ読む形に変えました。毎日の記録より、読む時間を楽しめるほうを大切にしました。決まった曜日だけにする方法は合いそうですか？",discourse:"The learner narrates an adjustment and asks whether a lighter schedule would suit the partner.",profile:NARRATE_AND_REFLECT},{japanese:"予定どおりにできないと目標が負担になるので、忙しい日は休み、余裕のある日に戻る形にしました。回数は減っても、長く続けられるほうが自分には現実的でした。短い時間だけ続ける方法は合いそうですか？",discourse:"The learner describes a flexible recovery strategy and asks a concrete preference question.",profile:NARRATE_AND_REFLECT}],followUps:[{partner:"毎日の決まりにするより、できる日に短くやるほうが続きそうです。",prompt:text("回應對方的選擇，提出一個保持彈性的下一步。","相手の選択に応じ、柔軟さを保つ次の一歩を提案しましょう。","Respond and suggest a flexible next step."),choices:[{japanese:"それなら負担が少なそうですね。本を見える場所に置けば、思い出すきっかけだけ作れて、読む量までは決めずに済みそうです。",discourse:"The learner proposes a small environmental cue without making a demand.",profile:NEGOTIATE_WITH_REASON},{japanese:"できる日に短く、という形が合いそうですね。最初に一章だけと決めると、忙しい日に量を調整しやすいかもしれません。試してみませんか？",discourse:"The learner offers a bounded optional step that follows the partner's preference.",profile:NEGOTIATE_WITH_REASON}]},{partner:"まずは気が向いた日に始めて、様子を見たいです。",prompt:text("接受對方想先觀察的節奏，確認一個不具壓力的下一步。","様子を見たいという相手のペースを受け止め、負担のない次の一歩を話しましょう。","Accept the partner's pace and discuss one low-pressure next step."),choices:[{japanese:"いいですね。始めた日に、読んだところを一行だけメモするのはどうですか？",discourse:"The learner checks an optional reflection step rather than imposing a schedule.",profile:NEGOTIATE_WITH_REASON},{japanese:"まず試してみるのがよさそうです。続け方は後から決めてもよいですね。",discourse:"The learner accepts the partner's proposal and keeps future choices open.",profile:ANSWER_ONLY}]}],completion:text("你敘述了目標的經驗，聽取不同限制，並找到可調整而不勉強的下一步。","目標の経験を話し、違う事情も聞きながら、無理のない次の一歩を考えられました。","You narrated a goal experience, heard a different constraint, and found an adaptable next step.")})
    ]
  },
  {
    ...
    phases:[
      draftPhase({phase:"before",length:"short",learnerRole:"coworker",partnerRole:"coworker",relationship:text("友善同事，平常會談休息方式。","休み方を話す、親しみのある同僚。","Friendly coworkers who discuss ways to rest."),situation:text("同事看到八月日曆上的休假標記，聊到自己可選擇的安排。","同僚が八月のカレンダーを見て、休みの日にできることを話しています。","Coworkers notice a holiday marker on an August calendar and discuss optional plans."),objective:text("詢問對方想如何休息，不預設登山或旅行。","登山や旅行を前提にせず、どう休みたいか尋ねましょう。","Ask how the partner might rest without assuming hiking or travel."),instruction:text("分享低風險的個人選擇，保留在家休息的可能。","気軽な個人の選択を話し、家で休む可能性も残しましょう。","Share an optional plan and leave room for staying home."),primarySkills:["share","bounce"],difficulty:BASIC_SUPPORTIVE,partner:"休みの日は、外に出る予定を立てていますか？",prompt:text("回答自己是否有計畫，也把問題交回對方。","予定があるか答え、相手にも尋ね返しましょう。","Say whether you have plans and return the question."),choices:[{japanese:"まだ決めていません。暑さが落ち着いたら近所を歩きたいです。",discourse:"The learner gives a tentative local option without prescribing outdoor activity.",profile:ANSWER_ONLY},{japanese:"今のところ、家でゆっくりするつもりです。あなたは何か考えていますか？",discourse:"The learner answers and asks about the partner's optional plans.",profile:ANSWER_AND_RETURN}],completion:text("你分享了個人休息選項，沒有把登山當成必要活動。","自分で選べる休み方を話し、登山を必須の活動とはしませんでした。","You shared an optional way to rest without treating hiking as required.")}),
  ...
  },
  {
    ...
    phases:[
      draftPhase({phase:"before",length:"short",learnerRole:"coworker",partnerRole:"coworker",relationship:text("會互相確認一般工作公告的同事。","普段の職場案内を確認し合う同僚。","Coworkers who clarify ordinary workplace notices."),situation:text("同事看到下週公布的例行演練通知，但尚未讀完整內容。","同僚が予定されている訓練の案内を見ましたが、詳細はまだ読んでいません。","Coworkers see a scheduled drill notice but have not read its details."),objective:text("確認公告是否影響一般工作流程。","通常の業務の流れに影響するか確認しましょう。","Clarify whether the notice affects the ordinary work routine."),instruction:text("只確認公告資訊，不提供緊急時建議或保證。","案内の内容だけ確認し、緊急時の助言や保証はしないようにしましょう。","Clarify the notice only; do not offer emergency advice or assurances."),primarySkills:["repair"],difficulty:BASIC_SUPPORTIVE,partner:"訓練の案内が出ていましたが、時間を確認しましたか？",prompt:text("回答已讀到的資訊，或提議一起確認公告。","確認した情報を答えるか、一緒に案内を確認する提案をしましょう。","Share what you know or suggest checking the notice together."),choices:[{japanese:"まだ詳しく読んでいません。開始時刻はどこに書いてありますか？",discourse:"The learner states what they have not checked and offers a neutral clarification.",profile:CLARIFY_ORDINARY_DETAIL},{japanese:"昼休みの後と書いてありましたが、場所はどこでしょう？案内を一緒に確認しませんか？",discourse:"The learner shares one ordinary detail and acknowledges what remains unclear.",profile:CLARIFY_ORDINARY_DETAIL}],completion:text("你把話題留在一般公告資訊，沒有把它當成緊急狀況。","通常の案内の確認にとどめ、緊急事態として扱いませんでした。","You kept the discussion to an ordinary notice rather than an emergency.")}),
      draftPhase({phase:"active",length:"short",learnerRole:"coworker",partnerRole:"coworker",relationship:text("在工作場所保持平等互助的同事。","職場で対等に助け合う同僚。","Coworkers who help one another as peers."),situation:text("同事在公告欄前確認例行演練的集合時間。","同僚が掲示板の前で通常訓練の集合時刻を確認しています。","Coworkers check the meeting time for a routine drill notice."),objective:text("用簡單問題釐清一個尚未確認的公告細節。","未確認の案内について、簡単な質問で確かめましょう。","Clarify one unconfirmed detail with a simple question."),instruction:text("不要猜測未寫明的程序，也不宣稱某種做法保證安全。","書かれていない手順を推測せず、何かが安全を保証すると言わないようにしましょう。","Do not guess at unstated procedures or claim any action guarantees safety."),primarySkills:["repair"],difficulty:INTERMEDIATE_SOCIAL,partner:"集合場所は一階のロビーのようですが、掲示の文字が少し読みにくいですね。",prompt:text("確認不清楚的文字，提出查閱公告的中性問題。","読みづらい箇所を確かめるため、案内を見直す質問をしましょう。","Ask a neutral question to check the unclear text."),choices:[{japanese:"場所の欄を一緒に見てもいいですか？ロビーかどうか確認したいです。",discourse:"The learner asks to verify the written location rather than guessing.",profile:CLARIFY_ORDINARY_DETAIL},{japanese:"場所の欄を一緒に読み直してもいいですか？小さい文字を確認したいです。",discourse:"The learner proposes rereading the ordinary notice together.",profile:CLARIFY_ORDINARY_DETAIL}],completion:text("你以公告文字為依據釐清細節，沒有猜測未公布的程序。","案内の記載をもとに確認し、書かれていない手順は推測しませんでした。","You checked the posted information without guessing at unstated procedures.")}),
      draftPhase({phase:"after",length:"short",learnerRole:"coworker",partnerRole:"coworker",relationship:text("可以分享一般工作經驗而不誇大效果的同事。","通常の職場経験を誇張せずに話せる同僚。","Coworkers who can share routine work experiences without overstating effects."),situation:text("例行演練後，同事談到公告是否容易理解。","通常訓練の後、同僚が案内の分かりやすさを話しています。","After a routine drill, coworkers discuss whether the notice was clear."),objective:text("分享一項溝通觀察，再詢問對方的看法。","案内について気づいた点を一つ話し、相手の考えを尋ねましょう。","Share one observation about the notice and ask for the partner's view."),instruction:text("只回顧溝通體驗，不評估實際防災能力。","案内の経験だけを振り返り、防災能力を評価しないようにしましょう。","Reflect on communication only; do not assess preparedness or safety capability."),primarySkills:["narrate","expand"],difficulty:INTERMEDIATE_SOCIAL,partner:"集合場所が大きく書いてあって、案内を見つけやすかったです。",prompt:text("分享自己看公告的經驗，再讓對方補充觀察。","案内を見た経験を話し、相手にも尋ね返しましょう。","Share your experience of the notice and return the turn."),choices:[{japanese:"私も場所はすぐ分かりました。時刻も同じ大きさで書いてあると見やすそうです。",discourse:"The learner reports a personal observation and one modest communication preference.",profile:NARRATE_AND_REFLECT},{japanese:"見つけやすかったですね。どの情報が特に分かりやすかったですか？",discourse:"The learner acknowledges and asks about the partner's observation.",profile:ACKNOWLEDGE_AND_INVITE}],completion:text("你回顧了公告的清晰程度，沒有宣稱演練帶來特定安全成效。","案内の分かりやすさを振り返り、訓練の安全効果は断定しませんでした。","You reflected on notice clarity without claiming a specific safety outcome.")})
    ]
  },
  {
    ...
    phases:[
      ...
      draftPhase({phase:"after",length:"long",learnerRole:"coworker",partnerRole:"coworker",relationship:text("彼此熟悉口味差異並保持禮貌的同事。","好みの違いを知り、礼儀を保って話す同僚。","Coworkers who know one another's preferences and remain considerate."),situation:text("同事回顧一次選飲品的對話，其中一人偏好咖啡，另一人多選茶。","同僚が飲み物を選んだ時の会話を振り返っています。一人はコーヒーを好み、もう一人はお茶を選ぶことが多いです。","Coworkers recall choosing drinks; one prefers coffee while the other often chooses tea."),objective:text("敘述一次點飲品的經驗，理解不同口味並商量都自在的選項。","飲み物を選んだ経験を話し、好みの違いを受け止めて、どちらも気楽な選択肢を考えましょう。","Narrate a drink choice, recognize different tastes, and negotiate an option that feels comfortable to both."),instruction:text("說明選擇原因，回應不同口味，提出可各自點不同飲品的方案。","選んだ理由を話し、違う好みに応じて、それぞれ別の飲み物を選べる案を出しましょう。","Explain your choice, respond to different tastes, and suggest ordering different drinks."),primarySkills:["narrate","agree_disagree","negotiate"],difficulty:ADVANCED_REFLECTIVE,partner:"前に一緒に入った店では、私はコーヒーで、あなたはお茶にしましたね。",prompt:text("敘述當時自己選擇的原因，再詢問對方的看法。","その時に選んだ理由を話し、相手の考えも尋ねましょう。","Narrate why you chose that drink and ask the partner's view."),choices:[{japanese:"午後だったので、私は軽いお茶にしました。香りを楽しみたい時とすっきりしたい時で選び分けられると、午後の過ごし方に合わせやすいです。",discourse:"The learner narrates a bounded choice and suggests a flexible arrangement.",profile:NARRATE_AND_REFLECT},{japanese:"その日はお茶にしましたが、食事の後はコーヒーを選ぶこともあります。飲み物を合わせるより、その時の気分や食事に合わせて選ぶほうが私は落ち着きます。",discourse:"The learner explains a preference and recognizes that different orders can coexist.",profile:NARRATE_AND_REFLECT}],followUps:[{partner:"一緒に来た時は、同じものを頼むほうが会話しやすいと思います。",prompt:text("回應對方對分別點餐的看法，提出保持舒服的選店方法。","別々に頼めるという相手の考えに応じ、店の選び方を一つ話しましょう。","Respond to the idea of ordering separately and discuss a comfortable way to choose a cafe."),choices:[{japanese:"同じものを選ぶ楽しさもありますね。ただ、好みが違う時は選択肢が多いほうが、無理なく一緒に過ごせると思います。",discourse:"The learner recognizes the appeal of ordering alike, then gives a reason for keeping different choices available.",profile:DIFFERENT_VIEW_WITH_REASON},{japanese:"私もそう思います。メニューを見てから、それぞれ好きなものを選びませんか？",discourse:"The learner proposes a shared selection process while preserving individual choice.",profile:ACKNOWLEDGE_AND_INVITE}]},{partner:"次に店を選ぶ時、何を見て決めるとよさそうですか？",prompt:text("提出一個實用的選店條件，也確認對方是否合適。","店を選ぶ時に重視したい条件とその理由を話し、相手に合うか確かめましょう。","Offer one practical criterion and check whether it works for the partner."),choices:[{japanese:"飲み物の種類が多いと、好みが違っても選べるので重視したいです。お茶も選びやすいですか？",discourse:"The learner proposes an inclusive menu criterion and checks the partner's preference.",profile:NEGOTIATE_WITH_REASON},{japanese:"静かに話せる席も大切です。注文を急がず話せますし、飲み物は別々に選べるとよいですね。",discourse:"The learner suggests a setting criterion while accommodating different drinks.",profile:NEGOTIATE_WITH_REASON}]}],completion:text("你敘述了飲品選擇，理解彼此口味不同，並提出各自都能自在選擇的方式。","飲み物を選んだ経験を話し、好みの違いを受け止めて、それぞれ選べる方法を考えました。","You narrated a drink choice, recognized different tastes, and found a flexible way to choose.")})
    ]
  },
  {
    ...
    phases:[
      draftPhase({phase:"before",length:"short",learnerRole:"classmate",partnerRole:"classmate",relationship:text("會一起查找公共展覽資訊、但各自決定是否參加的同學。","公共展示の情報を一緒に調べ、参加は各自で決めるクラスメート。","Classmates who look up public exhibitions but decide individually whether to attend."),situation:text("同學看到附近美術館的展覽公告。","クラスメートが近くの美術館の展示案内を見ています。","Classmates notice an exhibition announcement at a nearby museum."),objective:text("詢問對方是否感興趣，並說明自己喜歡看的作品類型。","興味があるか尋ね、自分が見たい作品の種類も話しましょう。","Ask whether the partner is interested and share what kind of work you enjoy."),instruction:text("把參觀當成選項，不預設假日安排。","見学は選択肢として話し、祝日の予定を決めつけないようにしましょう。","Keep visiting optional; do not assume holiday plans."),primarySkills:["share","bounce"],difficulty:BASIC_SUPPORTIVE,partner:"駅の近くで写真の展示が始まるそうです。興味はありますか？",prompt:text("回答自己的興趣，也讓對方談想看的內容。","自分の興味を答え、相手が見たいものも尋ねましょう。","Share your interest and ask what the partner might like to see."),choices:[{japanese:"写真を見るのが好きなので、少し興味があります。どんな展示が好きですか？",discourse:"The learner answers and returns the topic with an optional question.",profile:ANSWER_AND_RETURN},{japanese:"まだ分かりませんが、案内を読んでみたいです。写真のテーマは何でしょうね。",discourse:"The learner expresses tentative interest and suggests checking the public notice.",profile:ANSWER_ONLY}],completion:text("你分享了個人興趣，並保留是否參觀的選擇。","自分の興味を話し、見に行くかどうかは選べるままにしました。","You shared a personal interest while keeping the visit optional.")}),
      draftPhase({phase:"active",length:"short",learnerRole:"participant",partnerRole:"participant",relationship:text("在公共展場交談的參觀者。","公共の展示会場で話す来場者同士。","Visitors chatting in a public exhibition space."),situation:text("參觀者觀察一幅作品的構圖與色彩。","来場者が作品の構図や色を見ています。","Visitors observe the composition and colors of a work."),objective:text("分享一項可見觀察，聽聽對方的解讀。","目に見える特徴を一つ話し、相手の見方を聞きましょう。","Share one visible observation and hear the partner's interpretation."),instruction:text("描述自己的感受，不要求對方同意，也不複製作品文字。","自分の感想として話し、同意を求めず、作品の文章も写さないようにしましょう。","Describe your impression without demanding agreement or copying artwork text."),primarySkills:["share","bounce"],difficulty:INTERMEDIATE_SOCIAL,partner:"この作品は、色の重なりが印象的ですね。",prompt:text("分享自己注意到的部分，再邀請對方補充。","自分が気づいた点を話し、相手にも尋ねましょう。","Share what you noticed and invite the partner's view."),choices:[{japanese:"私は背景の明るさが気になりました。どの色が一番印象に残りましたか？",discourse:"The learner shares an observation and returns the discussion to the partner.",profile:ANSWER_AND_RETURN},{japanese:"重なった色で奥行きがあるように見えます。近くで見ると違う印象ですね。",discourse:"The learner offers a personal visual interpretation without asserting it is correct.",profile:ANSWER_ONLY}],completion:text("你分享了個人觀察，並尊重作品解讀可能不同。","自分の見方を話し、作品の受け取り方が違うことも尊重できました。","You shared a personal observation and respected that interpretations can differ.")}),
      draftPhase({phase:"after",length:"long",learnerRole:"classmate",partnerRole:"classmate",relationship:text("可以談不同審美感受、不要求一致的同學。","感じ方の違いを話し、意見の一致を求めないクラスメート。","Classmates who discuss different impressions without requiring agreement."),situation:text("同學回顧看過的一個展覽作品，以及各自注意到的細節。","クラスメートが見た展示作品と、それぞれが気づいた点を振り返っています。","Classmates recall an exhibition work and the details each noticed."),objective:text("敘述一段觀展經驗，接納不同品味，再詢問對方的感受。","展示を見た経験を話し、違う好みも受け止めて、相手の感想を尋ねましょう。","Narrate a viewing experience, accept different tastes, and ask about the partner's impression."),instruction:text("說明印象改變的原因，回應不同看法，不替作品下唯一結論。","印象が変わった理由を話し、違う見方にも応じ、唯一の結論を出さないようにしましょう。","Explain why your impression changed and respond without declaring one correct interpretation."),primarySkills:["narrate","agree_disagree","expand"],difficulty:ADVANCED_REFLECTIVE,partner:"最初は少し暗いと思いましたが、説明を読んだ後は見方が変わりました。",prompt:text("敘述自己如何看待一個細節，並詢問對方改變看法的部分。","自分が見た特徴を話し、相手の見方が変わった点を尋ねましょう。","Narrate a detail you noticed and ask what changed for the partner."),choices:[{japanese:"私も説明を読んで、作品の背景を少し想像できました。どの部分が気になりましたか？",discourse:"The learner narrates a shift in impression and returns the question.",profile:NARRATE_AND_REFLECT},{japanese:"私は色の使い方を先に見たので、説明を読む前は暗さより静けさを感じました。受け取り方が違うと、作品を考える視点も増えますね。",discourse:"The learner gives a different impression with a reason and leaves room for the partner’s reading.",profile:DIFFERENT_VIEW_WITH_REASON}],followUps:[{partner:"私は、繰り返し出てくる形が気になりました。",prompt:text("回應對方提到的圖形，分享一個相近或不同的觀察。","繰り返し出てくる形に応じ、自分の似た点や違う点を話しましょう。","Respond to the repeated shape with a similar or different observation."),choices:[{japanese:"同じ形が何度も出てきますね。私はその間の余白にも目が行きました。",discourse:"The learner recognizes the observation and offers a different visual focus.",profile:ANSWER_ONLY},{japanese:"繰り返しに気づいたんですね。どの場所に出てくる形が印象的でしたか？",discourse:"The learner develops the partner's chosen observation with a focused question.",profile:ACKNOWLEDGE_AND_INVITE}]},{partner:"友人と感想が違っても、作品の見方が広がることがありますね。",prompt:text("回應不同解讀帶來的收穫，分享自己保留多種看法的方式。","解釈の違いで気づきが広がることに応じ、複数の見方を持つ自分の方法を話しましょう。","Respond to how different interpretations can broaden a view and share how you hold more than one reading."),choices:[{japanese:"一つに決めずに見ると、後から別の点にも気づけます。私は気になったことを短くメモします。",discourse:"The learner reflects on how they keep multiple interpretations open and describes a concrete practice.",profile:NARRATE_AND_REFLECT},{japanese:"違う感想を聞くと、もう一度見たくなります。自分の見方も変わるか考えてみます。",discourse:"The learner describes how a different interpretation prompts reconsideration without requiring agreement.",profile:NARRATE_AND_REFLECT}]}],completion:text("你敘述了觀展時的感受變化，也延續了對不同觀察的交流。","展示を見た時の感じ方を話し、違う観察についても会話を続けられました。","You narrated how your impression changed and continued a discussion of different observations.")})
    ]
  },
  {
  ...
  },
  {
    ...
    phases:[
      draftPhase({phase:"before",length:"medium",learnerRole:"coworker",partnerRole:"coworker",relationship:text("能談個人選擇而不預設共同活動的同事。","個人の選択を話し、共同行事を前提にしない同僚。","Coworkers who discuss personal choices without presuming a shared event."),situation:text("年末，兩位同事談到如何為忙碌一年的最後一天留點空間。","年末、同僚同士で一年の最後の日をどう過ごすか話しています。","At year end, coworkers discuss how to leave some space on the last day of the year."),objective:text("協商一個安靜聚會的可能選項，讓雙方都能保留自己的步調。","静かな集まりの選択肢を考え、お互いのペースを保ちましょう。","Discuss a quiet optional gathering while preserving each person's pace."),instruction:text("不預設參加宗教活動或熬夜；每個提議都可以婉拒。","宗教行事への参加や夜更かしを前提にせず、提案は断れる形にしましょう。","Do not assume religious observance or staying up; keep every suggestion optional."),primarySkills:["negotiate","bounce"],difficulty:INTERMEDIATE_SOCIAL,partner:"年末は、静かに過ごす時間も少し作りたいと思っています。",prompt:text("分享一個自選的安靜安排，再詢問對方偏好。","自分で選べる静かな過ごし方を話し、相手の好みを尋ねましょう。","Share an optional quiet plan and ask the partner's preference."),choices:[{japanese:"家で温かいものを飲みながら、今年の写真を整理したいです。どんな過ごし方が落ち着きますか？",discourse:"The learner shares a low-pressure plan and asks about the partner's preference.",profile:NEGOTIATE_WITH_REASON},{japanese:"短い散歩をしてから家で休むのがよさそうです。外出しない過ごし方も考えていますか？",discourse:"The learner offers a modest option and asks about the partner's pace.",profile:ANSWER_AND_RETURN}],followUps:[{partner:"私は人が多い場所は避けて、家で好きな番組を見るつもりです。",prompt:text("接納對方想待在家裡的選擇，討論一個低壓力的共處方式。","家で過ごす相手の選択を受け止め、負担のない過ごし方を考えましょう。","Acknowledge the partner's choice to stay home and discuss a low-pressure way to spend time."),choices:[{japanese:"家でゆっくりするのもいいですね。私は同じ部屋で別々のことをするのも好きです。",discourse:"The learner accepts a different preference and suggests a non-demanding shared setting.",profile:ANSWER_ONLY},{japanese:"その過ごし方が落ち着きそうですね。話しながら過ごすより、それぞれ静かにするのがよさそうですか？",discourse:"The learner checks what kind of quiet company the partner prefers.",profile:ACKNOWLEDGE_AND_INVITE}]}],completion:text("你提出了可選擇的安靜安排，也回應了對方想在家的偏好。","静かな選択肢を話し、家で過ごしたい相手の好みにも応じられました。","You discussed an optional quiet plan and responded to the partner's preference to stay home.")}),
      ...
      draftPhase({phase:"after",length:"short",learnerRole:"classmate",partnerRole:"classmate",relationship:text("平常會回顧生活小事、彼此不追問家庭計畫的同學。","日々の出来事を振り返るが、家庭の予定は尋ねないクラスメート。","Classmates who recall everyday moments without probing family plans."),situation:text("新的一年開始後，同學回憶一個年末留下印象的時刻。","新しい年になり、クラスメートが年末に印象に残った瞬間を振り返っています。","After the new year begins, classmates recall one memorable year-end moment."),objective:text("描述一個自己選擇記住的片刻，並邀請對方分享。","自分が覚えている一場面を話し、相手にも尋ねましょう。","Describe one moment you chose to remember and invite the partner's story."),instruction:text("回憶個人經驗，不假設參拜、聚會或特定倒數活動。","個人の経験を振り返り、参拝や集まり、特定のカウントダウンは前提にしないようにしましょう。","Recall a personal moment without assuming a shrine visit, gathering, or countdown."),primarySkills:["narrate","bounce"],difficulty:INTERMEDIATE_SOCIAL,partner:"年末は家でゆっくりして、好きな音楽を聞いていました。",prompt:text("分享一個自己記得的年末時刻，再問對方喜歡的部分。","覚えている年末の場面を話し、相手が気に入ったことも尋ねましょう。","Share a year-end moment and ask what the partner enjoyed."),choices:[{japanese:"私は温かい飲み物を用意して、去年撮った写真を見返しました。どんな音楽を聞いていましたか？",discourse:"The learner narrates a chosen year-end moment and returns the topic.",profile:NARRATE_AND_RETURN},{japanese:"私は静かに本を読んでいました。好きな音楽を聞くと、ゆっくりできますね。",discourse:"The learner shares a personal memory and responds to the partner's routine.",profile:NARRATE_AND_REFLECT}],completion:text("你敘述了一個自選的年末片刻，也邀請對方分享自己的回憶。","自分で選んだ年末の場面を話し、相手の思い出も聞けました。","You narrated a chosen year-end moment and invited the partner's memory.")})
    ]
  },
];
