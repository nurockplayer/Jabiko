...
const n1Patterns: GrammarPattern[] = [
  {
    ...
    pattern: "〜まことに",
    meaningZh: "誠然、實在（正式）",
    meaningJa: "本当に／誠に（改まった表現）",
    formation: "副詞（慣用）",
    importance: "understand",
    tags: ["正式", "強調"],
    examples: [
      { japanese: "まことに申し訳ございません。", meaningZh: "實在非常抱歉。" },
    ],
    mediaExamples: [],
    relatedPatternIds: [],
  },
  {
    ...
    level: "N1",
    pattern: "〜ざるを得ない",
    meaningZh: "不得不～（強制性比 N2 更強）",
    meaningJa: "〜するしかない／強い義務",
    formation: "動詞ない形（−ない）＋ざるを得ない；する→せざるを得ない",
    importance: "must_know",
    tags: ["義務", "必然", "重複"],
    examples: [
      { japanese: "否応なく、計画を変更せざるを得なかった。", meaningZh: "不管願不願意，都不得不變更計畫。" },
    ],
    mediaExamples: [],
    relatedPatternIds: ["wake-niwa-ikanai"],
  },
  {
    ...
    tags: ["譲歩", "口語"],
    examples: [
      { japanese: "忙しいにもあるけど、やっぱり行くべきだ。", meaningZh: "雖然說很忙，但還是該去。" },
    ],
    mediaExamples: [],
    relatedPatternIds: ["ni-shitemo"],
  },
  ...
  },
  {
    ...
    pattern: "〜いわば",
    meaningZh: "可說是～、也就是說",
    meaningJa: "言ってみれば／例えるなら",
    formation: "副詞（慣用）",
    importance: "understand",
    tags: ["比喩", "説明"],
    examples: [
      { japanese: "彼はいわば現代のサムライだ。", meaningZh: "他可說是現代的武士。" },
    ],
    mediaExamples: [],
    relatedPatternIds: [],
  },
  {
    ...
    pattern: "〜にもあらず",
    meaningZh: "並非～、並非不～",
    meaningJa: "〜ではない／必ずしも〜ない",
    formation: "名詞＋にもあらず",
    importance: "understand",
    tags: ["否定", "古風"],
    examples: [
      { japanese: "不可能にもあらず、だが難しい。", meaningZh: "並非不可能，但很困難。" },
    ],
    mediaExamples: [],
    relatedPatternIds: [],
  },
  ...
  },
  {
    ...
    tags: ["感嘆", "評価"],
    examples: [
      { japanese: "情けないことという、彼は一言も謝らなかった。", meaningZh: "可悲的是，他一句道歉都沒有。" },
    ],
    mediaExamples: [],
    relatedPatternIds: [],
  },
  {
    ...
    mediaExamples: [],
    relatedPatternIds: ["to-wa-omoenai"],
  },
  {
    id: "to-wa-omoenai",
    level: "N1",
    ...
    meaningZh: "不覺得～、難以想像～",
    meaningJa: "〜だとは信じられない",
    formation: "動詞・形容詞普通形＋とは思えない",
    importance: "understand",
    tags: ["推測", "否定"],
    examples: [
      { japanese: "彼がそんなことをするとは思えない。", meaningZh: "不覺得他會做那種事。" },
    ],
    mediaExamples: [],
    relatedPatternIds: ["to-wa-kagiranai"],
  },
  {
    id: "nakaideha-n1",
    level: "N1",
    ...
    tags: ["範囲", "限定"],
    examples: [
      { japanese: "日本語学習者の中では、彼はかなりできるほうだ。", meaningZh: "在日語學習者之中，他算是相當不錯的。" },
    ],
    mediaExamples: [],
    relatedPatternIds: [],
  },
  ...
  },
  {
    ...
    pattern: "〜にも及ばず",
    meaningZh: "不及～、比不上～；不必～",
    meaningJa: "〜に劣る／〜する必要はない",
    formation: "名詞＋にも及ばず；動詞辞書形＋には及ばない",
    importance: "understand",
    tags: ["比較", "否定"],
    examples: [
  ...
  },
  {
    ...
    meaningZh: "忍耐～、難以忍受～",
    meaningJa: "〜をこらえて",
    formation: "動詞辞書形＋しのぶに",
    importance: "reference",
    tags: ["感情", "困難"],
    examples: [
      { japanese: "悲しみをしのぶに、彼は酒を飲んだ。", meaningZh: "為了忍耐心中的悲傷，他喝了酒。" },
    ],
    mediaExamples: [],
    relatedPatternIds: [],
  },
