...
export const learningBlocks: LearningBlock[] = [
  ...
  },
  {
    ...
    pitfalls: [
      ...
      "配對沒有單一公式，常見規律（く→ける、る→す…）可參考，但要逐組記"
    ],
    completionMode: "reference",
    examDrill: { labelKey: "drillN3Grammar", level: "N3", promptLabel: "文法形式選擇" },
    drillNote: "※ 這章是文法整理；按鈕去練 N3 文法形式選擇題庫，邊練邊熟。",
  ...
  },
  {
    ...
    explanation:
      "敬語三類。丁寧語：です／ます，對聽者的基本禮貌。尊敬語：抬高「對方」的動作（来る・行く・いる→いらっしゃる、食べる→召し上がる、見る→ご覧になる、言う→おっしゃる、する→なさる；一般動詞用 お＋ます形＋になる）。謙譲語：壓低「自己」的動作以抬高對方（行く・来る→伺う・参る、食べる→いただく、見る→拝見する、言う→申す／申し上げる、する→いたす；一般動詞用 お＋ます形＋する）。",
    examples: [
    ...
    pitfalls: [
      ...
      "別二重敬語：「お召し上がりになる」過頭，召し上がる 本身已是尊敬",
  ...
  },
  {
    ...
    explanation:
      "「ばかり」三個常見用法。Vた＋ばかり＝才剛（動作完成不久，帶主觀「沒多久」）。Vて＋ばかり（いる）＝光是、老是（負面，只做某事）。名詞＋ばかり＝淨是、全是（語氣依上下文，常見負面但不一定）。",
    examples: [
      { formula: "日本に来たばかりで、まだ慣れない", note: "Vた＋ばかり：才剛…" },
      { formula: "弟はゲームをしてばかりいる", note: "Vて＋ばかり：老是…（負面）" },
