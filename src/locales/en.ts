...
export const en: Copy = {
  ...
  modeOptions: {
    ...
    vocab: { title: "Vocabulary readings", subtitle: "N1–N3 kanji words · pick the correct reading (よみ)" },
  ...
  homeCardVocabSub: "Quick reading checks on N1–N3 kanji words. Meanings are tested in sentences in the full bank; here it's pure よみ.",
