...
export const en: Copy = {
  ...
  focusLabel: "Focus",
  focusStartLabel: "Start focus",
  focusEndLabel: "End focus",
  focusConfigureTitle: "Focus settings",
  focusConfigureFocusMinutes: "Focus (minutes)",
  focusConfigureBreakMinutes: "Break (minutes)",
  focusConfigureSave: "Start",
  focusBreakTitle: "Take a break",
  focusBreakRestPrompt: "Relax, stretch, or grab a drink before the next round.",
  focusSkipBreak: "Skip break",
  focusNextCycle: "Start next round",
  focusEndMode: "End Focus Mode",
  focusSummaryFocus: "Focus time",
  ...
  homeConjugationMain: "Verb conjugation",
  homeConjugationSub: "See a verb and target form, then type the answer from memory.",
  ...
  homeCardBookmarksTitle: "Bookmarks",
  homeCardBookmarksSubActive: (count) => `${count} starred questions, ready to re-drill any time.`,
  homeCardBookmarksSubEmpty: "Star questions while practising, then re-drill them from here.",
  homeCardBookmarksMeta: "Tap ☆ on any question to save it",
  homeQuickLinksLabel: "Reference",
  ...
  kanaGroupSeion: "Seion (basic)",
  kanaGroupDakuon: "Dakuon / handakuon",
  kanaGroupYouon: "Yoon (contracted)",
  ...
  drillConditional: "Drill conditional (ば) form",
  ...
  drillPatternN4Jikan: "Drill time patterns",
  drillPatternN4Juju: "Drill giving + requests",
  drillPatternN4Chikaku: "Drill perception + limits",
  ...
  answerMode: "Answer style",
  answerModes: { choice: "Choices", recall: "Type the answer" },
  ...
  recallAnswerLabel: "Type the conjugated form",
  recallAnswerPlaceholder: "Type your answer",
  recallSubmit: "Submit answer",
  recallKeyboardHint: "Press Enter to answer, then Enter again for the next question",
  ...
  grammarPagerLabel: "Previous and next grammar patterns",
  ...
  modeOptions: {
    ...
    vocab: { title: "Vocabulary readings", subtitle: "N1–N5 kanji words · pick the correct reading (よみ)" },
  ...
  homeCardVocabSub: "Quick reading checks on N1–N5 kanji words. Meanings are tested in sentences in the full bank; here it's pure よみ.",
  homeCardVocabMeta: "Perfect for spare moments on the commute",
  homeCardVocabTitleStarter: "Starter vocabulary",
  homeCardVocabSubStarter: "95 starter words: see the word, pick the meaning. All kana, no kanji needed.",
  homeCardVocabMetaStarter: "Right after learning kana",
  homeBannerNextLearnMain: "Start the starter course",
  homeBannerNextLearnSub: "Kana → starter words → basic sentences, one step at a time.",
  homeBannerNextExamMain: (band) => `Start ${band} exam prep`,
  homeBannerNextExamAllMain: "Start the mixed question bank",
  ...
  conversationSummaryTitle: "This run",
  conversationPracticedLabel: "Response moves practised",
  conversationCuratedNote:
    "Feedback is human-curated and shown offline right away. There is no AI grading and no audio playback.",
  conversationLengths: { short: "Short", medium: "Medium", long: "Long" },
  conversationDimensions: {
    understandable: "Understandable",
    correct: "Correct",
    natural: "Natural",
    continuation: "Keeps going",
    register_context_fit: "Fits the situation"
  },
  conversationStatus: { met: "Met", needs_work: "Needs work" },
  conversationComposition: { answer: "Answer", add: "Add", ask: "Ask" },
  homeCardConversationTitle: "Small Talk",
  homeCardConversationSub: "Short everyday Japanese conversations, separate from JLPT drills.",
  homeCardConversationMeta: "Short / medium / long",
  partOfSpeech: {
    verb: "Verb",
  ...
  focusOptions: {
    single: "Single form",
    coreConjugation: "Core verb conjugation",
    teTa: "て/た comparison",
  ...
  targetForms: {
    ...
    conditional: "Conditional・ば form",
