...
export const vi: Copy = {
  ...
  partnersContactBody: "Mọi trao đổi hợp tác xin gửi tới địa chỉ này.",
  loading: "Đang tải…",
  ...
  breadcrumbLabel: "Vị trí hiện tại",
  home: "Trang chủ",
  learn: "Học",
  rules: "Bảng quy tắc",
  ...
  focusStartLabel: "Bắt đầu tập trung",
  focusEndLabel: "Kết thúc tập trung",
  focusConfigureTitle: "Cài đặt tập trung",
  focusConfigureFocusMinutes: "Tập trung (phút)",
  focusConfigureBreakMinutes: "Nghỉ (phút)",
  focusConfigureSave: "Bắt đầu",
  focusBreakTitle: "Nghỉ ngơi",
  focusBreakRestPrompt: "Thư giãn, duỗi người hoặc uống nước trước vòng tiếp theo.",
  focusSkipBreak: "Bỏ qua nghỉ",
  focusNextCycle: "Bắt đầu vòng tiếp theo",
  focusEndMode: "Kết thúc Chế độ Tập trung",
  focusSummaryFocus: "Thời gian tập trung",
  ...
  homeConjugationMain: "Chia động từ",
  homeConjugationSub: "Xem động từ và thể mục tiêu, rồi tự nhập câu trả lời.",
  ...
  homeCardBookmarksTitle: "Mục đã lưu",
  homeCardBookmarksSubActive: (count) => `${count} câu đã đánh dấu, sẵn sàng luyện lại bất cứ lúc nào.`,
  homeCardBookmarksSubEmpty: "Đánh dấu sao khi luyện tập, rồi luyện lại từ đây.",
  homeCardBookmarksMeta: "Chạm ☆ trên trang câu hỏi để lưu",
  homeQuickLinksLabel: "Tra cứu",
  ...
  kanaGroupSeion: "Thanh âm (cơ bản)",
  kanaGroupDakuon: "Âm đục / bán đục",
  kanaGroupYouon: "Âm ghép",
  learningRegion: "Học",
  ...
  drillConditional: "Luyện thể điều kiện (ば)",
  ...
  drillPatternN4Jikan: "Luyện mẫu câu thời gian",
  drillPatternN4Juju: "Luyện cho nhận và nhờ vả",
  drillPatternN4Chikaku: "Luyện tri giác và giới hạn",
  ...
  answerModes: { choice: "Chọn đáp án", recall: "Tự nhập" },
  ...
  recallAnswerLabel: "Nhập dạng chia động từ",
  recallAnswerPlaceholder: "Nhập câu trả lời",
  recallSubmit: "Gửi câu trả lời",
  recallKeyboardHint: "Nhấn Enter để trả lời, rồi Enter lần nữa để sang câu tiếp theo",
  ...
  grammarPagerLabel: "Chuyển giữa các mẫu câu trước và sau",
  grammarPrev: "Trước",
  grammarNext: "Tiếp",
  grammar: "Ngữ pháp",
  ...
  modeOptions: {
    ...
    vocab: { title: "Cách đọc từ vựng", subtitle: "Từ kanji N1–N5 · chọn cách đọc đúng (よみ)" },
  ...
  homeCardVocabSub: "Kiểm tra nhanh cách đọc các từ kanji N1–N5. Nghĩa được kiểm tra trong câu ở ngân hàng đề đầy đủ; ở đây thuần túy là よみ.",
  ...
  conversationReset: "Làm lại",
  conversationChangeScenario: "Đổi tình huống",
  conversationPartnerLabel: "Lời người đối thoại",
  ...
  conversationSummaryTitle: "Lần luyện này",
  conversationPracticedLabel: "Động tác đáp đã luyện",
  conversationCuratedNote:
    "Phản hồi do người biên soạn, hiển thị ngay không cần mạng. Không chấm điểm bằng AI và không phát âm thanh.",
  conversationLengths: { short: "Ngắn", medium: "Vừa", long: "Dài" },
  conversationDimensions: {
    understandable: "Hiểu được",
    correct: "Chính xác",
    natural: "Tự nhiên",
    continuation: "Tiếp nối hội thoại",
    register_context_fit: "Hợp hoàn cảnh"
  },
  conversationStatus: { met: "Đạt", needs_work: "Cần cố thêm" },
  conversationComposition: { answer: "Trả lời", add: "Bổ sung", ask: "Hỏi lại" },
  homeCardConversationTitle: "Hội thoại hằng ngày",
  homeCardConversationSub: "Luyện hội thoại tiếng Nhật ngắn thường ngày, tách khỏi bài tập JLPT.",
  homeCardConversationMeta: "Ngắn / vừa / dài",
  partOfSpeech: {
    verb: "Động từ",
  ...
  focusOptions: {
    single: "Một thể",
    coreConjugation: "Chia động từ cốt lõi",
    teTa: "So sánh て/た",
