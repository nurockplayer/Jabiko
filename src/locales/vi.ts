...
export const vi: Copy = {
  ...
  modeOptions: {
    ...
    vocab: { title: "Cách đọc từ vựng", subtitle: "Từ kanji N1–N3 · chọn cách đọc đúng (よみ)" },
  ...
  homeCardVocabSub: "Kiểm tra nhanh cách đọc các từ kanji N1–N3. Nghĩa được kiểm tra trong câu ở ngân hàng đề đầy đủ; ở đây thuần túy là よみ.",
