...
export const ja: Copy = {
  ...
  aboutAuthorBody:
    "プログラミングコンテスト出身、Google に3年在籍したエンジニアで、2025年に退職し、現在は AI スタートアップで Tech Lead を務めています。日本語は10年前に N2 を取ってからしばらく放っていましたが、2024年に日本のアイドルを追い始めて再び火がつきました。それから少し時間ができたので、本腰を入れて練習を始めました——Jabiko はちょうどその頃に生まれたものです。最初は完全に自分用でしたが、思いがけず使ってくれる方が少しずつ増えました。せっかくなら、自分が心から満足できる作品に磨き上げて、日本語に情熱を持つ方々にもっと届け、同好の士と交流するきっかけにもしたいと思っています。サイトを作りながら自分でも使って学び続けています——目標は検定合格だけでなく、日本語の力全体を大きく伸ばすことです。",
