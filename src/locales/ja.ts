...
export const ja: Copy = {
  ...
  blogHeroTopicsLabel: "テーマ",
  blogHeroTopics: ["流行語","推し活・アイドル","ドラマ・アニメ","歌詞で学ぶ","日常会話"],
  blogHeroNote: "テーマは多彩、少しずつ更新中——読みたいテーマはフィードバックからどうぞ。",
  blogDraftBadge: "準備中",
  blogReadMore: "この記事を読む",
  blogNotFound: "記事が見つかりません。",
  blogCtaHint: "読みながら練習すると、より定着します。",
