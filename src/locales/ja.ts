...
export const ja: Copy = {
  ...
  chapterEyebrow: "コース章",
  chapterHeading: "一章ずつアンロック",
  chapterIntro: "章を選んでルール・例・よくある落とし穴を読み、チャレンジで練習しよう。",
  chapterStatusReference: "参考",
  chapterStatusComplete: "完了",
  chapterViewLabel: (title) => `表示：${title}`,
  chapterPrereqHint: (titles) => `先におすすめ：${titles}`,
  chapterExampleLabel: (title) => `${title}の例`,
  chapterPitfallsTitle: "よくある落とし穴",
