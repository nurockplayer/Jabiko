...
export const zhHant: Copy = {
  ...
  aboutStoryBody:
    "最早只有基礎變化練習，後來慢慢長出句中填空、句型判斷、JLPT 綜合題庫、題型練習、漢字讀音、弱點複習與學習儀表板——一步一步，越做越完整。",
  aboutAuthorTitle: "作者",
  ...
  feedbackTitle: "意見回饋",
  focusLabel: "專注",
  focusStartLabel: "開始專注",
  focusEndLabel: "結束專注",
  focusConfigureTitle: "專注設定",
  focusConfigureFocusMinutes: "專注時間（分鐘）",
  focusConfigureBreakMinutes: "休息時間（分鐘）",
  focusConfigureSave: "開始",
  focusBreakTitle: "休息一下",
  focusBreakRestPrompt: "放鬆一下，伸展或喝口水，再繼續下一輪。",
  focusSkipBreak: "略過休息",
  focusNextCycle: "開始下一輪",
  focusEndMode: "結束專注模式",
  focusSummaryFocus: "本次專注",
  ...
  homeDailySub: "先清錯題，再混合文法・語順・漢字読み練一輪。",
  homeConjugationMain: "動詞變化",
  homeConjugationSub: "看動詞與目標形，自己輸入答案。",
  homeStatsLabel: "整體進度",
  ...
  homeCardReviewMeta: "答錯立刻進錯題池 · 答對一次就移出",
  homeCardBookmarksTitle: "我的收藏",
  homeCardBookmarksSubActive: (count) => `${count} 題星標題目，隨時整組重練。`,
  homeCardBookmarksSubEmpty: "答題時按星號收藏，之後從這裡重練。",
  homeCardBookmarksMeta: "題目頁點 ☆ 即可收藏",
  homeQuickLinksLabel: "查資料",
  quickLinkGrammar: "文型資料庫",
  quickLinkKanji: "漢字音讀",
  quickLinkRules: "規則速查表",
  ...
  drillPatternN4Jikan: "練時間句型",
  drillPatternN4Juju: "練授受與請託",
  drillPatternN4Chikaku: "練知覺與限定",
  ...
  practiceFocus: "練習重點",
  answerMode: "答題方式",
  answerModes: { choice: "選項", recall: "自己輸入" },
  verbGroup: "動詞類別",
  targetForm: "目標形",
  answered: "已答",
  correctShort: "正解",
  ...
  answerOptions: "答案選項",
  recallAnswerLabel: "輸入變化後的日文",
  recallAnswerPlaceholder: "請輸入答案",
  recallSubmit: "送出答案",
  recallKeyboardHint: "Enter 送出；看到解析後再按 Enter 進下一題",
  revealAnswer: "看答案",
  nextQuestion: "下一題",
  ...
  modeOptions: {
    ...
    vocab: { title: "単字讀音", subtitle: "N1〜N5 漢字詞 · 選正確讀音（よみ）" },
  ...
  homeCardVocabSub: "N1〜N5 漢字詞讀音快測。意思在綜合題庫用句子來考，這裡專練よみ。",
  homeCardVocabMeta: "適合通勤碎片時間",
  homeCardVocabTitleStarter: "基礎詞彙",
  homeCardVocabSubStarter: "入門 95 詞：看詞選意思，全假名、不用會漢字。",
  homeCardVocabMetaStarter: "適合剛學完五十音",
  homeBannerNextLearnMain: "開始入門課程",
  homeBannerNextLearnSub: "五十音 → 基礎詞彙 → 基本句，一步一步來。",
  homeBannerNextExamMain: (band) => `開始 ${band} 備考`,
  homeBannerNextExamAllMain: "開始綜合考題庫",
  ...
  reviewEmptyState: "目前沒有錯題。答錯的題目會立刻出現在這裡，答對一次就會移出。",
  ...
  reviewDoneBody: (cleared, remaining) =>
    `這一輪複習了 ${cleared + remaining} 題，答對 ${cleared}、還要再練 ${remaining}。答對的已移出錯題池，答錯的會留著再練。`,
  ...
  conversationTitle: "日常會話練習室",
  conversationIntro: "用簡短的日常情境練習接話：選一個長度，依情境挑回應，再看人工整理的回饋。",
  conversationSeasonalTitle: "最近適合聊的季節話題",
  conversationSeasonalEmpty: "目前沒有適合介紹的季節話題，可以從日常情境開始。",
  conversationSeasonalPhases: { now: "現在", comingSoon: "即將到來", recent: "最近" },
  conversationStart: "開始這個情境",
  conversationContinue: "繼續",
  conversationRetry: "換個說法再試一次",
  conversationReset: "再跑一次",
  conversationChangeScenario: "換情境",
  conversationPartnerLabel: "對方的話",
  conversationLearnerRole: "你的角色",
  conversationPartnerRole: "對方的角色",
  conversationRelationship: "關係與語氣",
  conversationRoles: {
    "classmate": "同學",
    "classmate planning lunch with a visiting friend": "正和來訪朋友規劃午餐的同學",
    "classmate sharing a recent hobby": "分享最近新興趣的同學",
    "classmate who knows local lunch spots": "熟悉附近午餐地點的同學",
    "classmate who recently started knitting": "最近開始編織的同學",
    "community class participant": "社區課程的學員",
    "community event participant": "社區活動參加者",
    "coworker": "同事",
    "coworker who commutes by train": "搭電車通勤的同事",
    "coworker who sometimes commutes by bicycle": "偶爾騎腳踏車通勤的同事",
    "coworker who uses the Aoba Line": "搭青葉線通勤的同事",
    "junior coworker": "資淺同事",
    "local resident": "當地居民",
    "member who is joining an ongoing hobby conversation": "正加入既有興趣話題的成員",
    "new acquaintance who enjoys hiking but has limited energy for trips": "喜歡健行、但最近較沒心力遠行的新朋友",
    "new acquaintance who prefers nearby walks and photography": "偏好附近散步與攝影的新朋友",
    "new resident deciding how to commute": "正在考慮通勤方式的新住民",
    "participant": "活動參加者",
    "photo club member sharing a hobby": "分享興趣的攝影社成員",
    "senior coworker": "資深同事",
    "student and classmate": "學生兼同學",
    "student and seminar classmate": "學生兼研討課同學",
    "student with a part-time job": "有打工的學生",
    "student working on reports": "正在寫報告的學生"
  },
  conversationChooseResponse: "選一個回應",
  conversationFeedbackTitle: "回饋",
  conversationCompleteTitle: "完成",
  conversationSummaryTitle: "這次練習",
  conversationPracticedLabel: "練到的回應動作",
  conversationCuratedNote: "回饋由人工編輯，離線即時顯示；沒有 AI 評分，也沒有語音播放。",
  conversationLengths: { short: "短", medium: "中", long: "長" },
  conversationDimensions: {
    understandable: "可理解",
    correct: "正確",
    natural: "自然",
    continuation: "對話延續",
    register_context_fit: "場合與關係"
  },
  conversationStatus: { met: "達成", needs_work: "再加強" },
  conversationComposition: { answer: "回答", add: "補充", ask: "反問" },
  homeCardConversationTitle: "日常會話",
  homeCardConversationSub: "簡短生活情境的日語會話練習，獨立於 JLPT 備考。",
