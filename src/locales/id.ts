...
export const id: Copy = {
  ...
  partnersContactBody: "Kirim pertanyaan kerja sama ke alamat ini.",
  loading: "Memuat…",
  ...
  breadcrumbLabel: "Lokasi saat ini",
  home: "Beranda",
  learn: "Belajar",
  rules: "Tabel aturan",
  ...
  focusLabel: "Fokus",
  focusStartLabel: "Mulai fokus",
  focusEndLabel: "Akhiri fokus",
  focusConfigureTitle: "Pengaturan fokus",
  focusConfigureFocusMinutes: "Fokus (menit)",
  focusConfigureBreakMinutes: "Istirahat (menit)",
  focusConfigureSave: "Mulai",
  focusBreakTitle: "Istirahat",
  focusBreakRestPrompt: "Santai sejenak, meregang, atau minum sebelum putaran berikutnya.",
  focusSkipBreak: "Lewati istirahat",
  focusNextCycle: "Mulai putaran berikutnya",
  focusEndMode: "Akhiri Mode Fokus",
  focusSummaryFocus: "Waktu fokus",
  ...
  homeConjugationMain: "Konjugasi verba",
  homeConjugationSub: "Lihat verba dan bentuk target, lalu ketik jawaban dari ingatan.",
  ...
  homeCardBookmarksTitle: "Markah",
  homeCardBookmarksSubActive: (count) => `${count} soal berbintang, siap dilatih ulang kapan saja.`,
  homeCardBookmarksSubEmpty: "Beri bintang saat berlatih, lalu latih ulang dari sini.",
  homeCardBookmarksMeta: "Ketuk ☆ di halaman soal untuk menyimpan",
  homeQuickLinksLabel: "Referensi",
  ...
  drillConditional: "Latih bentuk pengandaian (ば)",
  ...
  answerMode: "Cara menjawab",
  answerModes: { choice: "Pilihan", recall: "Ketik jawaban" },
  ...
  recallAnswerLabel: "Ketik bentuk konjugasi",
  recallAnswerPlaceholder: "Ketik jawaban",
  recallSubmit: "Kirim jawaban",
  recallKeyboardHint: "Tekan Enter untuk menjawab, lalu Enter lagi untuk soal berikutnya",
  ...
  grammarPagerLabel: "Navigasi pola tata bahasa sebelumnya dan berikutnya",
  ...
  modeOptions: {
    ...
    vocab: { title: "Bacaan kosakata", subtitle: "Kata berkanji N1–N5 · pilih bacaan yang benar (よみ)" },
  ...
  homeCardVocabSub: "Tes cepat bacaan kata berkanji N1–N5. Artinya diuji lewat kalimat di bank soal komprehensif; di sini khusus latihan よみ.",
  ...
  conversationReset: "Ulangi",
  conversationChangeScenario: "Ganti situasi",
  conversationPartnerLabel: "Kata lawan bicara",
  ...
  conversationSummaryTitle: "Latihan kali ini",
  conversationPracticedLabel: "Gerakan balasan yang dilatih",
  conversationCuratedNote:
    "Umpan balik disusun manusia dan tampil langsung tanpa jaringan. Tidak ada penilaian AI dan tidak ada pemutaran audio.",
  conversationLengths: { short: "Pendek", medium: "Sedang", long: "Panjang" },
  conversationDimensions: {
    understandable: "Bisa dipahami",
    correct: "Tepat",
    natural: "Alami",
    continuation: "Percakapan lanjut",
    register_context_fit: "Sesuai situasi"
  },
  conversationStatus: { met: "Tercapai", needs_work: "Perlu latihan" },
  conversationComposition: { answer: "Jawab", add: "Tambah", ask: "Tanya" },
  homeCardConversationTitle: "Percakapan Harian",
  homeCardConversationSub: "Percakapan Jepang singkat sehari-hari, terpisah dari latihan JLPT.",
  homeCardConversationMeta: "Pendek / sedang / panjang",
  partOfSpeech: {
    verb: "Kata kerja",
  ...
  focusOptions: {
    ...
    coreConjugation: "Konjugasi verba inti",
  ...
  targetForms: {
    ...
    conditional: "Bentuk pengandaian・ば",
