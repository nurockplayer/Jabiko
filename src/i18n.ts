...
export const copy: Record<Language, Copy> = {
  ...
  en: {
    ...
    modeOptions: {
      ...
      vocab: { title: "Vocab reading", subtitle: "N1/N2 kanji words · pick the correct reading (よみ)" },
      review: { title: "Weak-spot review", subtitle: "Re-drill questions you got wrong until they stick" }
    },
    homeCardVocabTitle: "Vocab reading",
    homeCardVocabSub: "Fast N1 / N2 reading drill. Meaning is tested in context in the mock pool; this drills the よみ.",
  ...
  ko: {
    ...
    modeOptions: {
      ...
      vocab: { title: "단어 읽기", subtitle: "N1/N2 한자어 · 올바른 읽기(よみ) 고르기" },
      review: { title: "약점 복습", subtitle: "틀린 문제만 모아서 다시 풀기" }
    },
    homeCardVocabTitle: "단어 읽기",
    homeCardVocabSub: "N1 / N2 한자어 읽기 빠른 연습. 뜻은 종합 문제에서 문맥으로, 여기선 よみ만 집중.",
