...
// Static routes (mirrors src/domain/seo.ts view coverage) + the grammar index.
const ROUTES = [
...
console.log(`wrote public/sitemap.xml — ${ROUTES.length} routes + ${surfaces.length} grammar pages = ${entries.length} URLs`);
